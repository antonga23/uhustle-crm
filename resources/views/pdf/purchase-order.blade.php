      ...
      <table width="100%">
        <tr>
          <td colspan="6" style="padding-left: 0;">
            <table width="100%" style="border-collapse: collapse;">
              <tr>
                <td class="left-border top-border" style="height: 49px; vertical-align: bottom;">________________</td>
                <td class="top-border" style="height: 49px; vertical-align: bottom;">___________</td>
                <td class="right-border top-border" style="height: 49px; vertical-align: bottom;">________</td>
              </tr>
              <tr>
