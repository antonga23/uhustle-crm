  ...
  <div class="table-container">
    <b-table class="product-listing" :items="productListing" :per-page="perPage" :current-page="currentPage">
      ...
      <template slot="category_id" slot-scope="data">
        <a-select @change="updateProduct(data.item)"  name="Part Type" v-model="data.item.category_id" class="custom-select rounded-pill border-0">   
      ...
      <template slot="origin_type_id" slot-scope="data">
        <a-select name="Origin Type" @change="filterCompaniesByType(data.item.origin_type_id)" v-model="data.item.origin_type_id" class="custom-select rounded-pill border-0">   
          <a-select-option value="" selected>-None-</a-select-option>   
      ...
      <template slot="origin_id" slot-scope="data">
        <a-select @change="updateProduct(data.item)" name="Origin" v-model="data.item.origin_id" class="custom-select rounded-pill border-0">   
          <a-select-option value="" selected>-None-</a-select-option>   
      ...
      <template slot="supplier_id" slot-scope="data">
        <a-select @change="updateProduct(data.item)" name="Supplier" v-model="data.item.supplier_id" class="custom-select rounded-pill border-0">   
          <a-select-option value="" selected>-None-</a-select-option>   
      ...
      <template slot="tax_type" slot-scope="data">
        <a-select @change="updateProduct(data.item)" v-validate="'required'" name="Tax Type" v-model="data.item.tax_type" class="custom-select rounded-pill border-0">   
      ...
      <template slot="status" slot-scope="data">
        <a-select  @change="updateProduct(data.item)" v-validate="'required'" name="Status" v-model="data.item.status" class="custom-select rounded-pill border-0">   
          <a-select-option value="">-None-</a-select-option>   
