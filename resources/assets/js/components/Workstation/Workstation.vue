      ...
      <div :class="{ 'row' : true }" data-aos="fade-up" data-aos-duration="700" data-aos-offset="700" style="margin-top: 6%">
        ...
        <div>
          <div class="card client">
            <div class="card-body">
              <p class="card-text" :title="lead.name + ' ' + lead.surname">Cashed Out</p>
            </div>
          </div>
        </div>
        ...
        <div>
          <div class="card product">
            <div class="card-body">
              <p class="card-text" :title="lead.name + ' ' + lead.surname">Upsell</p>
            </div>
          </div>
        </div>
        ...
        <div>
          <div class="card activity">
            <div class="card-body">
              <p class="card-text" :title="lead.name + ' ' + lead.surname">More Info</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-4" style="padding-right: 35px;">
          <div class="card client">
            <div class="card-body">
              <h5 class="card-title">
              <img src="/images/workstation/D_A@4x.png" alt="Icon" class="icon" />Client</h5>
              <p 
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
                ...
                <div class="notes-capture">
                  ...
                  <button id="send-btn" type="submit" class="btn btn-primary w-75" @click="addComment()">Send</button>
                </div>            
              </div>
              <div class="tab-pane fade pt-0 px-3 pb-3" id="two" role="tabpanel" aria-labelledby="two-tab"> 
                ...
                <div class="row mb-0">
                  <div class="col-lg-12 pr-0">
                    ...
                    <button id="send-btn" type="submit" class="btn btn-primary" style="width:100px;" @click="addCallback()">Schedule</button>
                  </div>  
                </div>
              </div>
            </div>
