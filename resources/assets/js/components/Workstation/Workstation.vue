  ...
  <div id="workstation">
    ...
    <div class v-if="idle == false ">
      <div
        ...
        style="margin-top: 1%"
      >
        <div v-if="!is_oncall" :class="{ 'col-lg-12' : true, 'top-animation' : true }"></div>
        <div v-if="is_oncall" :class="{'col-lg-12' : true, 'top-animation-minimized' : true }"></div>
      </div>
    ...
    >
      <div class="row mx-0 pb-5 justify-content-between top-section agent-stats-1">
        <div
          v-if="item.custom_field_value !== null"
          class="col-6"
          v-for="(item, name, i) in module_item.item_meta"
          :key="i"
          v-show="item.custom_field_name !== 'owner'
        ...
        >
          <div
            class="2"
            v-for="(custom_field, index) in item_custom_fields"
            :key="index"
            v-if="item.custom_field_id == custom_field.id"
          >
            <div
              style="height: 47px;"
              class="inner-div border-bottom-grey"
              v-if="item.custom_field_id == custom_field.id && item.custom_field_value !== null"
            >
              <div
        ...
        <div class="card border-0 mb-0 ml-0 client">
          <div class="card-body">
            ...
            <div class="truncate w-100">
              <p
                v-if="module_item.item_meta[5].custom_field_value"
                class="card-link d-inline border-right border-white pb-3 pr-3"
              >{{ module_item.item_meta[5].custom_field_value }}</p>
              <p
                v-if="module_item.item_meta[9].custom_field_value"
                class="card-link d-inline border-right border-white ml-0 pb-3 px-3"
              >{{ module_item.item_meta[9].custom_field_value }}</p>
              <p
                v-if="module_item.item_meta[8].custom_field_value"
                class="card-link d-inline ml-0 pb-3 pl-3"
              >{{ module_item.item_meta[8].custom_field_value }}</p>
            </div>
          </div>
        </div>
                  ...
                  <li class="nav-item w-50">
                    ...
                    >
                      ...
                      <img
                        ...
                        alt="Add field icon"
                        width="16"
                        class="d-none add-activity"
                        @click="addActivityCollapse()"
                      />
                    </a>
                  </li>
