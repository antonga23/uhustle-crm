          ...
          <div class="card-deck mx-0">
            <div class="card my-0 ml-0 border-0 shadow-none tab-card">
              <div class="card-header tab-card-header border-bottom-0 p-0">
                <ul
                  class="nav nav-tabs card-header-tabs text-center mx-0"
                  id="myTab"
                  role="tablist"
                >
                      ...
                      <div class="row mx-0 justify-content-between">
                        <div class="col-6 pl-0">
                          <div class="progress-bar h-100">
                            <span
                              class="w-100 tank answers"
                              :style="{height: + comparison.answers + '%'}"
                            ></span>
                          </div>
                        </div>
          ...
          <div class="row container-row mx-0">
            <div class="col-3 pl-0">
              <div class="card h-100 border-0 target reached">
                <div class="card-text">
                  <p
                    class="w-100 font-weight-bold text-uppercase text-center heading"
                  >You've reached your monthly target</p>
                    ...
                    <div class="col-12 p-2"> 
                      <div class="row mx-0 align-items-center"> 
                        <div class="col pl-0 custom-control custom-checkbox"> 
                          ...
                          <br />
                          <span class="tasks-date">{{ moment(task.deadline).format( 'DD MMM') }} {{ moment(task.time).format( 'HH:mm') }}</span>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div
                          class="col-12 pr-0 custom-control"
                          v-if="edit_task && active_task_id == task.id"
                        >
                          <button
                            type="submit"
