...
<style scoped> 
  ...
  .middle-box-shadow { 
    box-shadow: 0px 0px 14px 2px rgba(235, 235, 235, 1);
    -webkit-box-shadow: 0px 0px 14px 2px rgba(235, 235, 235, 1);
    -moz-box-shadow: 0px 0px 14px 2px rgba(235, 235, 235, 1);
    -o-box-shadow: 0px 0px 14px 2px rgba(235, 235, 235, 1); 
    border-radius: 15px;
  } 
    ...
    <aside class="main-sidebar sidebar-light-primary"> 
      ...
      <section class="sidebar"> 
        <div class="sidebar-menu grey-scroll" data-widget="tree">  
          <nav class="navbar navbar-expand-md navbar-light bg-white mx-0 mb-0 p-0 w-100 row mx-0 justify-content-between align-items-center border-bottom"> 
              ...
              <li class="nav-item"> 
                <a class="nav-link icon p-0 mr-2" href="#" @click="showNotifications()"> 
                  ...
                  <img 
                    ...
                    class="inactive-icon"
                  > 
>>>>>>> 7422fab52a01edb659045e573c7a973c5dd58e9f
                </a> 
              </li> 
          ...
          <div class="open-sidenav mt-3">
            <div v-if="settings_on == true" class="settings px-2"> 
              ...
              <div class="row mx-0 preferences border-bottom" style="display:none;"> 
                <div class="row mx-0 justify-content-between align-items-center w-100 mx-0 p-0"> 
                  ...
                  <div class="col-auto"> 
                    ...
                    <img 
                      @click="expanded = false;system_settings_on = false;account_on = false;profile_on = false;language_settings_on = false;" 
                      v-else src="/images/icons/right-sidebar/Close Edit Icon.svg" 
                      alt="Account Edit Off" 
                      width="30"
                    > 
                  </div> 
              ...
              <div class="row mx-0 logout-wrapper" v-if="profile_on == false"> 
                ...
                <h3 class="d-block w-100 text-center">Logout</h3> 
              </div> 
            </div> 
                    ...
                    <b-tabs class="outer-box-shadow"> 
                      ...
                      <b-tab> 
                        <template v-slot:title>
                          <span class="mr-1">Reminders</span>
                          <a href="#" @click="addTask"> 
                            <img src="/images/icons/right-sidebar/Add_Task.svg" width="20" class="add-task"> 
                          </a>
                        </template>
                                ...
                                <div class="row mx-0"> 
                                  <div class="col-12 px-0 custom-control"> 
                                    <label class="w-100 terms-text" for="task1"> 
                                      <input v-model="new_task.title" placeholder="Title" type="text" class="border-0 pl-0 list-input"> 
                                    </label> 
