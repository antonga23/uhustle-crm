        ...
        <div class="col-auto">
          <ul class="navbar-nav left align-items-center">
            <li class="nav-item d-none d-sm-inline-block title pr-3">
              <a v-if="active == 'workstation'" href="#" class="nav-link pl-0">
              ...
              <a v-if="active == 'dashboard'" href="#" class="nav-link pl-0">
                <strong>Dashboard</strong>
              </a>
              <a v-if="active == 'call-history'" href="#" class="nav-link pl-0">
                <strong>Call History</strong>
              </a>
              <a v-if="active == 'social-board'" href="#" class="nav-link pl-0">
                <strong>Social Board</strong>
              </a>
              <a v-if="active == 'users'" href="#" class="nav-link pl-0">
                <strong>Users</strong>
              </a>
              <a v-if="active == 'leads'" href="#" class="nav-link pl-0">
                <strong>Leads</strong>
              </a>
              <a v-if="active == 'contacts'" href="#" class="nav-link pl-0">
                <strong>Contacts</strong>
              </a>
              <a v-if="active == 'inventory'" href="#" class="nav-link pl-0">
                <strong>Inventory</strong>
              </a>
              <a v-if="active == 'preferences'" href="#" class="nav-link pl-0">
                <strong>System Preferences</strong>
              </a>
              <a v-if="active == 'transactions'" href="#" class="nav-link pl-0">
...
<!-- 
            ...
            <li
              v-if="(active == 'users' || active == 'leads' || active == 'contacts')"
              class="nav-item d-none d-sm-inline-block pl-3"
            >
              <a
                href="#"
                @click="addNew();"
...
export default {
  ...
  methods: {
    getDialerSettings() {
      var vm = this;
      axios
        .get("/roles/get-dialer-permissions/" + this.current_user.role_id)
        .then(function(response) {
          if (response.data.success == true) {
            ...
            vm.$swal(
              "Failed",
              "Opps, something went wrong while retrieving Dialer settings, please try again",
              "warning"
            );
          }
        });
